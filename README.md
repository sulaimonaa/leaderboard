...
**[leaderboard]** This project allows user to add score to leaderboard
...
```sh
  cd my-folder
  git clone https://github.com/sulaimonaa/leaderboard
```
...
- [ ] **[use of es6 import and export functions]**
